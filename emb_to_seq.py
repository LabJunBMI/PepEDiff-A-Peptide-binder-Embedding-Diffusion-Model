...
EMB_FILE = "./data/{batch_idx}_{seed}.pkl"
SEQ_FILE = "./data/seq_checked_{seed}.pkl"
SCALER_FILE = "./z_score_scaler.pkl"
...
def emb_to_seq_check(
    emb,
    model,
    tokenizer,
    noise_scale=0.3,
    noise_step=0.1,
    noise_step_thresh=50,
    total_thresh=500,
    tqdm_bar: tqdm = None,
):
    success_flag = False
...
if __name__ == "__main__":
    ...
    for seed in range(10):
        ...
        for pdb_id, e in tqdm_bar:
            e = torch.Tensor(np.array([embedding_scale.inverse_transform(e)])).to(
                DEVICE
            )
